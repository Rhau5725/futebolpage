      ...
      <section className="section pricing" id="oferta">
        <div className="wrap">
          ...
          <div className="plans">
            ...
            <article className="plan complete"><div className="popular">★ MAIS VENDIDO</div><div className="plan-top"><span>Plano Completo</span><p>A experiência completa para o seu melhor treino.</p></div><div className="price"><small>De <s>R$87,00</s> por apenas</small><strong><sup>R$</sup>27<span>,00</span></strong></div><ul>{completeItems.map(x=><li key={x}>✓ <span>{x}</span></li>)}</ul><div className="plan-trust-banner"><img src="/images/secure-email-banner.png" alt="Compra segura, satisfação garantida, dados protegidos e acesso por e-mail" /></div><a className="button primary" href="#">Quero o Plano Completo <b>→</b></a><small className="secure">🔒 Compra 100% segura</small></article>
          </div>
        </div>
      </section>
