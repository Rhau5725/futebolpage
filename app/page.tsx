...
const bonuses = [
  ["Aquecimentos Prontos", "Exercícios rápidos para começar com organização, intensidade e preparação física.", "/images/bonus-1-aquecimentos.webp", "R$27,00"],
  ["Certificados de Craque", "Modelos para reconhecer a dedicação, evolução e participação dos atletas.", "/images/bonus-2-certificados.webp", "R$17,00"],
  ["Organização de Treinos", "Estruture sessões eficientes e mantenha a equipe motivada do início ao fim.", "/images/bonus-3-organizacao.webp", "R$23,00"],
  ["Agilidade e Velocidade", "Desenvolva explosão, coordenação e mudança de direção com exercícios completos.", "/images/bonus-4-agilidade.webp", "R$20,00"],
];
...
const receivedSlides = [
  ["/images/receive-dynamics.webp", "Exemplo das mais de 250 dinâmicas de futebol"],
  ["/images/receive-warmups.webp", "Bônus de aquecimentos prontos"],
    ...
    <main>
        ...
        <div className="hero-grid wrap">
          <div className="hero-copy">
            ...
            <div className="hero-visual">
              <div className="image-shell"><img src="/images/hero-complete-material.webp" alt="Material completo com mais de 250 dinâmicas e bônus para treinos de futebol" fetchPriority="high" decoding="async" /></div>
            </div>
      ...
      <section className="section showcase">
        <div className="wrap">
          ...
          <div className="showcase-image"><img src="/images/kids-football-training.webp" alt="Crianças participando de um treino organizado de futebol" loading="lazy" decoding="async" /></div>
      ...
      <section className="section bonuses" id="bonus">
        <div className="wrap">
          ...
          <div className="bonus-grid">{bonuses.map(([title,text,image,price], i) => <article className="bonus-card" key={title}><div className="bonus-image"><img src={image} alt={`Bônus ${i + 1}: ${title}`} loading="lazy" decoding="async" /></div><div className="bonus-body"><div className="bonus-number">BÔNUS {i + 1}</div><h3>{title}</h3><p>{text}</p><div className="bonus-price"><span>De <s>{price}</s></span><strong>GRÁTIS</strong></div></div></article>)}</div>
        </div>
      </section>
      ...
      <section className="section pricing" id="oferta">
        <div className="wrap">
          ...
          <div className="plans">
            ...
            <article className="plan complete"><div className="popular">★ MAIS VENDIDO</div><div className="plan-top"><span>Plano Completo</span><p>A experiência completa para o seu melhor treino.</p></div><div className="plan-product-image"><img src="/images/vip-complete-mockup.webp" alt="Mockup do conteúdo completo com mais de 250 dinâmicas e Área VIP" loading="lazy" decoding="async" /></div><div className="price"><small>De <s>R$87,00</s> por apenas</small><strong><sup>R$</sup>27<span>,00</span></strong></div><ul>{completeItems.map(x=><li key={x}>✓ <span>{x}</span></li>)}</ul><div className="plan-trust-banner"><img src="/images/secure-email-banner.webp" alt="Compra segura, satisfação garantida, dados protegidos e acesso por e-mail" loading="lazy" decoding="async" /></div><a className="button primary" href="https://go.perfectpay.com.br/PPU38CQEILN">Quero o Plano Completo <b>→</b></a><small className="secure">🔒 Compra 100% segura</small></article>
          </div>
        </div>
      </section>

      <section className="section guarantee"><div className="wrap guarantee-grid"><div className="guarantee-image"><img src="/images/guarantee-7-days.webp" alt="Satisfação garantida por 7 dias" loading="lazy" decoding="async" /></div><div><span className="kicker gold">RISCO ZERO</span><h2>Garantia de satisfação</h2><p>Você tem 7 dias para conhecer o material com tranquilidade e solicitar suporte caso não fique satisfeito.</p></div></div></section>
